(function(a) {
    ...
    elFinder.prototype.options = {
        ...
        toolbar: [["back", "reload"], ["select", "open"], ["mkdir", "mkfile", "upload"], ["copy", "paste", "rm"], ["rename", "edit"], ["info", "quicklook", "resize"], ["icons", "list"], ["help"]],
        contextmenu: {
                ...
                for (d = 0; d < e[h].length; d++) {
                    ...
                    if (this.cmd[o]) {
                        ...
                        this.buttons[o] = a('<li class="' + o + '" title="' + this.cmdName(o) + '" name="' + o + '" />').appendTo(this.fm.view.tlb).click(function(i) {
                            ...
                            return function() { ! a(this).hasClass("disabled") && i.exec(a(this).attr("name"))
                            }
        ...
        resize: function(c) {
            ...
            this.exec = function() {
                ...
                if (l[0] && l[0].write && l[0].dim) {
                    ...
                    k = parseInt(j[1]),
                    e = g / k;
                    iw = a('<input type="text" size="9" value="' + g + '" name="width"/>'),
                    ih = a('<input type="text" size="9" value="' + k + '" name="height"/>'),
    ...
    elFinder.prototype.quickLook = function(l, b) {
        ...
        this.hide = function() {
            if (this.win.is(":visible")) {
                var i,
                e = p.fm.view.cwd.find('[key="' + this._hash + '"]');
                if (e) {
                    i = e.offset();
                    this.media.hide(200);
                    this.win.animate({
        ...
        this.updateCwd = function() {
            ...
            function(g) {
                ...
                helper: function() {
                    ...
                    j = 0; ! g.hasClass("ui-selected") && b.fm.select(g, true);
